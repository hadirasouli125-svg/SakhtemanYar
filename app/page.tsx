...
export default function Home(){
 ...
 async function load(r=role){setLoading(true);setError('');try{const j=await call(r==='manager'?'manager_dashboard':'resident_dashboard',{},t);setData(j)}catch(e:any){setError(e.message||'خطا در دریافت اطلاعات')}finally{setLoading(false)}}
